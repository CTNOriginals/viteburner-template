...
if (document.head.querySelector("#simple-box-css")) (document.head.querySelector("#simple-box-css") as HTMLElement)!.innerText=css;
...
export let createSimplebox=(title,content)=>{
	...
	let simplebox = document.querySelector("body>div:last-of-type")! as HTMLElement;
	...
	** Mouseup will clear the ongoing tracking. */
	simplebox.querySelector(".head")!.addEventListener("mousedown", e =>{
		...
		let mouseInitialX = (e as MouseEvent).clientX;
		let mouseInitialY = (e as MouseEvent).clientY;
